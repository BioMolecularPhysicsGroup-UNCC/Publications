...
set reflig [atomselect $mol1 "resid 1 to 110 and noh"  frame 0]
...
set selProt [atomselect $mol1 "resid 111 to 448 and noh"]
...
# all ligand atoms
set ligatoms [atomselect $mol1 "resid 1 to 110 and noh"]

#output files
set outfile [open $out_name-lig_Hbond_$Hdist.dat w]
