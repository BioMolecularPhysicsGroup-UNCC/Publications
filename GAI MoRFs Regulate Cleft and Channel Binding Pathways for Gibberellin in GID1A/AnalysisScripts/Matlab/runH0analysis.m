%%%
%Author: JP
% Default analysis work up for Hbond list produced in vmd
...
h0bondMapper("");
h0bondUncapMapper("");
h0bondEgressionMapper("");




function h0bondMapper(sysName)
...
% finputData=input("Name of data files\n",'s');
% finputStruct=input("Name of pdb file\n",'s');
% uniqueTag=input("Name of unique tags\n",'s');
...
pause(20);
close all
clearvars -except finputData finputStruct uniqueTag sysName

end
end
function h0bondUncapMapper(sysName)
...
function h0bondEgressionMapper(sysName)
finputData=["MoRF1_H0bond_3.5.dat",...
    "MoRF2_H0bond_3.5.dat","MoRF3_H0bond_3.5.dat",...
    "lig_H0bond_3.5.dat"];
finputStruct="ref.pdb";
