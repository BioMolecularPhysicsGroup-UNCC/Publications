...
if( isfile(strcat("./VMD_output/",finputData{a})) )
   fid = fopen("./VMD_output/"+finputData{a});
...
hold on;
pdbFrame = pdb2mat(finputStruct);
FileList = dir(strcat('./VMD_output/uncap*',finputData{a}));
colourList=hsv(length(FileList));
TotalResList={};
TotalWaterList={};
for i=1 : length(FileList)
...
finputData=["MoRF1_H0bond_3.5.dat",...
    "MoRF2_H0bond_3.5.dat","MoRF3_H0bond_3.5.dat",...
    "lig_H0bond_3.5.dat"];
finputStruct="ref.pdb";
uniqueTag=[strcat(sysName,"_MoRF1"),strcat(sysName,"_MoRF2"),...
strcat(sysName,"_MoRF3"),strcat(sysName,"_lig")];
