...
set reflig [atomselect $mol1 "resid 97 to 104 and noh"  frame 0]
...
#set selProt [atomselect $mol1 "resid 105 to 448 or resid 1 to 96 and noh"]
set selProt [atomselect $mol1 "resid 1 to 96 or resid 105 to 448"]
...
# all ligand atoms
set ligatoms [atomselect $mol1 "resid 97 to 104 and noh"]

#output files
set outfile [open $out_name-MoRF3_Hbond_$Hdist.dat w]
