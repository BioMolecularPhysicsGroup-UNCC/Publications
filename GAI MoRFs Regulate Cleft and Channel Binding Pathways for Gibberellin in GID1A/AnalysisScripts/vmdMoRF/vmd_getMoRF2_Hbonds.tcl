...
set reflig [atomselect $mol1 "resid 69 to 91 and noh"  frame 0]
...
#set selProt [atomselect $mol1 "resid 92 to 448 or resid 1 to 68 and noh"]
set selProt [atomselect $mol1 "resid 1 to 68 or resid 92 to 448"]
...
# all ligand atoms
set ligatoms [atomselect $mol1 "resid 69 to 91 and noh"]

#output files
set outfile [open $out_name-MoRF2_Hbond_$Hdist.dat w]
