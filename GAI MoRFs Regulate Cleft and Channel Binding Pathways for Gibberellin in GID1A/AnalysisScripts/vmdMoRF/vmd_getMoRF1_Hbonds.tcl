...
set reflig [atomselect $mol1 "resid 24 to 55 and noh"  frame 0]
...
#set selProt [atomselect $mol1 "resid 111 to 448 or resid 1 to 23 or resid 56 to 110 and noh"]
set selProt [atomselect $mol1 "resid 1 to 23 or resid 56 to 448"]
...
# all ligand atoms
set ligatoms [atomselect $mol1 "resid 24 to 55 and noh"]

#output files
set outfile [open $out_name-MoRF1_Hbond_$Hdist.dat w]
...
for { set frame 0 } {$frame < $n } { incr frame } {
 ...
 #set listProt [measure hbonds $Hdist 30 $ligatoms $selProt]
