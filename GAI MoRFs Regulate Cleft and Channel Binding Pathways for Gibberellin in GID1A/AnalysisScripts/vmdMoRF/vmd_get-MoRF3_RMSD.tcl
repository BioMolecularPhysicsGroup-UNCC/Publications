...
set reference [atomselect $mol1 "resid 97 to 104 and noh" frame 0]
...
set sel [atomselect $mol1 "resid 97 to 104 and noh"]
set sel1 [atomselect $mol1 "all"]
set n [molinfo $mol1  get numframes]
#output files
set outfile2 [open $out_name-MoRF3_rmsd.dat w]
